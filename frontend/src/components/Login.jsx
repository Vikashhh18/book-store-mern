    ...
    <div className='h-[calc(100vh-120px)]  flex items-center flex-col justify-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
               ...
               <div>
                <button className='py-2 px-8 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded focus:outline-none cursor-pointer'>Login</button>
               </div>
            </form>
            <p className='align-baseline font-medium mt-4 text-sm '>Haven't an account ? Please 
                <Link to={"/register"} className='text-blue-500 hover:text-blue-700 cursor-pointer' > Register</Link>
            </p>
           <div className='mt-4'>
